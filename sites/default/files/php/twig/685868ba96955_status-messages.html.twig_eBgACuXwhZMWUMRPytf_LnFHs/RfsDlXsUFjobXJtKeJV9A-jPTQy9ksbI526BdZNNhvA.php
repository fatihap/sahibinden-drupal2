...
class __TwigTemplate_e9e831874dc15b7372441319c26256c7 extends Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
            ...
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($_v0 = ($context["status_headings"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[$context["type"]] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["status_headings"] ?? null), $context["type"], [], "array", false, false, true, 24)), "html", null, true);
            yield "\"";
    ...
    ";
            ...
            // line 28
            yield "    ";
            if ((($tmp = (($_v1 = ($context["status_headings"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess && in_array($_v1::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v1[$context["type"]] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["status_headings"] ?? null), $context["type"], [], "array", false, false, true, 28))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 29
                yield "      <h2 class=\"visually-hidden\">";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($_v2 = ($context["status_headings"] ?? null)) && is_array($_v2) || $_v2 instanceof ArrayAccess && in_array($_v2::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v2[$context["type"]] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["status_headings"] ?? null), $context["type"], [], "array", false, false, true, 29)), "html", null, true);
                yield "</h2>
    ";
            }
            // line 31
...
";
    ...
    {
        return new Source("", "core/themes/stable9/templates/media-library/status-messages.html.twig", "/Users/fatihapaydin/Documents/drupal/web/core/themes/stable9/templates/media-library/status-messages.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["for" => 23, "if" => 25];
        static $filters = ["escape" => 24, "without" => 24, "length" => 31, "first" => 38];
        static $functions = [];
