...
/* themes/custom/sogep/components/ilanlar/templates/views-view-table--ilanlar.html.twig */
class __TwigTemplate_c972846e9e9ccbfe0b6361ab61a2e336 extends Template
{
...
($context["header"] ?? null))), "table", "table-striped", "table-bordered", (((($tmp =         // line 40
...
($context["fields"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[$context["key"]] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["fields"] ?? null), $context["key"], [], "array", false, false, true, 65)))];
  ...
  ";
    ...
    {
        return "themes/custom/sogep/components/ilanlar/templates/views-view-table--ilanlar.html.twig";
    }
