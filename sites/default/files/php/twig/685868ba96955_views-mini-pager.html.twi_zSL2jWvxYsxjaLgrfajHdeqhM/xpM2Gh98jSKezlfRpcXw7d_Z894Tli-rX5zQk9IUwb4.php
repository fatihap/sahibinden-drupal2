...
class __TwigTemplate_4e8cf8e5d21adc669732a63476e1f554 extends Template
{
    ...
    <ul class=\"js-pager__items\">
      ...
      ";
          ...
          ";
                // line 28
                yield t("Page @items.current", ["@items.current" => CoreExtension::getAttribute($this->env, $this->source,                 // line 29
($context["items"] ?? null), "current", [], "any", false, false, true, 29), ]);
      ...
      ";
            ...
            // line 33
            yield "      ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 33)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 34
                yield "        <li>
          <a href=\"";
                // line 35
...
";
    ...
    {
        return new Source("", "core/themes/stable9/templates/views/views-mini-pager.html.twig", "/Users/fatihapaydin/Documents/drupal/web/core/themes/stable9/templates/views/views-mini-pager.html.twig");
    }
